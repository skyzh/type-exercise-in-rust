# Chapter 10: Build a One-Level List Column
...
- **Change:** support List array, constant, dictionary, and typed-null representations.
- **Preserve:** dictionary validation and expected/actual type errors from Chapter 3.
- **Run:** the full Chapter 10 contract.
...
Next: [Chapter 11 turns Rust boundary claims into executable checks](./chapter-11-rust-boundaries.md).
