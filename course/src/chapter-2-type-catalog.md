...
The starter contains commented declarations and signatures for later chapters at their
implementation locations. Leave each one commented until its checkpoint asks you to uncomment
and implement it.
