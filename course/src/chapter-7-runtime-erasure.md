# Chapter 7: Erase Typed Expressions at Runtime
...
**Prerequisites:** Chapter 6, trait objects, and checked enum recovery.
...
- **Change:** keep `name`, `input_types`, `output_type`, and `evaluate` free of associated types, and
  require `Any + Send + Sync` for checked recovery and sharing.
...
- **Run:** the Chapter 7 catalog and delegation tests.
...
Next: [Chapter 8 binds logical calls and applies the promotion contract](./chapter-8-binding-coercion.md).
