...
registration waits until Chapter 8. Concrete four- and five-input builtins are extensions. The
archived source-tree-writing generator is not a course goal; if you generate boilerplate, use a
source-controlled declarative macro.
...
Next: [Chapter 7 hides the typed shells behind one runtime interface](./chapter-7-runtime-erasure.md).
