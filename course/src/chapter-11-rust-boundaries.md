# Chapter 11: Strengthen Rust Type Boundaries
...
**Prerequisites:** Chapter 10, `Any`, trait objects, threads, and lifetime variance.
...
- **Run:** the Chapter 11 focused test and doctests.
