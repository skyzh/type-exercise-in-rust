# Chapter 8: Bind and Coerce Logical Calls
...
**Prerequisites:** Chapters 2, 5, and 7; `HashMap`; closures; logical versus physical types.
...
## Checkpoint 3: keep promotion lossless
...
- **Run:** the full Chapter 8 contract.
...
Next: [Chapter 9 specializes one representative dense loop](./chapter-9-primitive-loops.md).
