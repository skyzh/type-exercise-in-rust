...
//!
//! Day 12, checkpoint 1: uncomment these declarations, choose useful private fields, and add the
...
// }
//
//! Day 12, checkpoint 2: uncomment these declarations and add checked outer List storage here.
// #[derive(Clone, Debug, PartialEq)]
