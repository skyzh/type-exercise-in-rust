...
//!
//! Chapter 9: uncomment these declarations, choose useful private fields, and add the
...
// }
//
//! Chapter 9: uncomment these declarations and add checked outer List storage here.
// #[derive(Clone, Debug, PartialEq)]
