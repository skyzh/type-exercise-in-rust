...
use crate::{
    ...
    Expression, PhysicalType, build_bool_comparison_expression, build_boolean_binary_expression,
    build_boolean_not_expression, build_numeric_binary_expression, build_numeric_clamp_expression,
...
type FunctionFactory = dyn Fn(&[DataType]) -> Result<BoundExpression, BindError> + 'static;
...
impl FunctionRegistry {
    ...
    ///
    /// ```compile_fail
    /// use type_exercise_checkpoint_09_expr::{BindError, FunctionRegistry};
    ///
