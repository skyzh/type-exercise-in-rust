...
use crate::{
    ...
    evaluate_binary, evaluate_ternary, evaluate_unary, try_auto_vectorize_ternary,
    try_evaluate_binary,
};
...
/// Chapter 3's stable facade example, retained by every cumulative checkpoint.
pub fn add_i16_i32(
